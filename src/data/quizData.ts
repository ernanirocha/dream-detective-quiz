...
export const questions: QuestionData[] = [
  {
    ...
    options: [
      { id: 1, text: 'Minha mente acelera, não consigo "desligar".' },
      { id: 2, text: "Meu corpo fica tenso, mesmo cansado." },
      { id: 3, text: "Durmo, mas acordo várias vezes." },
    ],
    globalFeedback:
      "Isso mostra que seu corpo ainda está em modo de alerta. O cérebro precisa de sinais de segurança e nutrientes calmantes (magnésio, melatonina natural) pra liberar o sono profundo.",
  },
  {
    id: 2,
    ...
    globalFeedback:
      "Quando o corpo passa meses sem sono profundo, ele reduz vitamina D3 e hormônios do sono. Dá pra restaurar com suplementos naturais e rotina noturna leve.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    globalFeedback:
      "Esses hábitos reduzem sua melatonina natural e mantêm o corpo em alerta. Experimente um app de relaxamento guiado e pratique higiene do sono.",
  },
  {
    id: 5,
    ...
    globalFeedback:
      "Perfeito. Já sei qual tipo de solução natural combina com seu perfil. Veja duas estratégias práticas e um artigo bônus pra testar hoje.",
  },
];
